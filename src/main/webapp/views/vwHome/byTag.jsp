    ...
    >
      ...
      >
        ...
        <div class="w-fit gap-x-2 flex items-center">
          <p class="text-lg text-gray-600 font-bold">Tags:</p>
          <p
          ...
          >
            ...
            <div class="flex flex-col gap-y-1 w-full lg:w-2/5">
              ...
              <a class="text-lg text-gray-600 font-bold" href="">
                Mua sắm chống dịch: Thanh tra vào cuộc, nhà thầu đồng loạt trả
                lại tiền
              </a>
            ...
            <p class="text-sm text-gray-500 font-regular w-full lg:w-3/5">
              ...
              laborum provident magni repudiandae sint ratione illo aliquid
              quae, vitae in laudantium, quibusdam nihil consectetur quis amet
              ...
              aliquid quae, vitae in laudantium, quibusdam nihil consectetur
              quis amet aspernatur officiis culpa. Earum. repudiandae sint
              ratione illo aliquid quae, vitae in laudantium, quibusdam nihil
              consectetur quis amet aspernatur officiis culpa. Earum. Lorem
              ipsum dolor sit amet consectetur adipisicing elit. Similique
              laborum provident magni
            </p>
          </div>
        </c:forEach>
      </div>
