    ...
    <jsp:body>
        ...
        >
            ...
            >
                ...
                <c:forEach items="${ftxSearchArticles}" var="sA">
                    <!-- Div chua tung bai bao -->
                    <a href="${pageContext.request.contextPath}/Home/Article?id=${sA.articleID}">
                        <div
                        ...
                        >
                            ...
                            <div class="flex flex-col gap-y-1 w-full lg:w-2/5">
                                ...
                                <a class="text-lg text-gray-600 font-bold" href="${pageContext.request.contextPath}/Home/Article?id=${sA.articleID}">
                                        ${sA.title}
                                </a>
                                <p class="text-gray-500 text-sm">${sA.publish_date}</p>
                            </div>
