    ...
    >
        ...
        >
            ...
            <tr>
                ...
                <th scope="col" class="py-3 px-6">Tác giả</th>
            ...
            >
                ...
                <td class="py-4 px-6">
                    <p class="truncate text-gray-500 text-sm max-w-[300px]">
                        HLV Park nhận huân chương lao động hạng 3 Lorem ipsum,
                        dolor Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. Quia, perferendis nulla dicta doloremque, quis,
                        officiis incidunt cumque sit similique vitae eos. Omnis
                        quaerat delectus laboriosam quidem obcaecati, reiciendis
                        molestiae? Distinctio!
                    </p>
                </td>
                <td class="py-4 px-6">Hưng Đoàn</td>
                <td class="py-4 px-6">
                    <form
                            name="changeRole"
                            method="post"
                    ...
                    >
                        ...
                        >
                            <option value="Subcriber" selected>
                                Chưa được duyệt
                            </option>
                            <option value="Writer">Bị từ chối</option>
                            <option value="Editor">Đã xuất bản</option>
                            <option value="">Chờ xuất bản</option>
                        </select>
                    </form>
                </td>
                <td class="py-4 px-6">
